...
module.exports = {
    ...
    getStopsByRoute: function (agency_key, route_id, direction_id, cb) {
        ...
        function getStopTimes(cb) {
            //TODO: use unique stop_ids instead of stopTimes or longestTrip
            _.each(direction_ids,
                function (direction_id) {
                    //console.log("trip_ids[direction_id]", trip_ids[direction_id]);
                    ...
                    StopTime.find()
                        ...
                        .distinct('stop_id')
                        .exec(function (err, distinct_stop_ids) {
                            stop_ids[direction_id] = distinct_stop_ids;
                            //console.log(distinct_stop_ids, "distinct_stop_ids");
        ...
        function getStops(cb) {
            async.forEach(
                ...
                function (direction_id, cb) {
                    //console.log("longestTrip[direction_id]", longestTrip[direction_id]);
                        ...
                        function (stop_id, cb) {
                            ...
                            Stop.findOne()
                                ...
                                .exec(function (e, stop) {
                                    ...
                                    //console.log("stops[direction_id].indexOf(stop)", stops[direction_id].indexOf(stop));
    ...
    getInterpolatedBusPositionsForBusStop: function (agency_key, end_stop_id, cb) {
    ...
    getTimesByStopForAll: function (agency_key, stop_id, direction_id, cb) {
        var numOfTimes = 1000; //this is dumb but no calls to getTimesByStop() seem
        //to want to give it a numOfTimes argument. 1000 is probably at least 10x
        //more times than will be returned.
